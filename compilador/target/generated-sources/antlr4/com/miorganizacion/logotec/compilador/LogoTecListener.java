...
public interface LogoTecListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterHazHastaStmt(LogoTecParser.HazHastaStmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogoTecParser#hazHastaStmt}.
	 * @param ctx the parse tree
	 */
	void exitHazHastaStmt(LogoTecParser.HazHastaStmtContext ctx);
	/**
	 * Enter a parse tree produced by {@link LogoTecParser#hazMientrasStmt}.
	 * @param ctx the parse tree
	 */
	void enterHazMientrasStmt(LogoTecParser.HazMientrasStmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link LogoTecParser#hazMientrasStmt}.
	 * @param ctx the parse tree
	 */
	void exitHazMientrasStmt(LogoTecParser.HazMientrasStmtContext ctx);
	/**
